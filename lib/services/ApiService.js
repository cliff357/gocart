...
// Static categories (previously from MockData — inlined after dead code cleanup)
const PRODUCT_CATEGORIES = ['Headphones', 'Speakers', 'Watch', 'Earbuds', 'Mouse', 'Decoration'];
...
export class ProductApiService extends BaseApiService {
    ...
    static async getCategories() {
        this.log('Product', 'getCategories', 'Fetching categories');
        return this.createResponse(PRODUCT_CATEGORIES);
    }
