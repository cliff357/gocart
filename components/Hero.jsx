        ...
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group overflow-hidden'>
                    {banners.main ? (
                        <img src={banners.main} alt="Main Banner" className="absolute inset-0 w-full h-full object-cover" />
                    ) : (
                        <>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-orange-200 rounded-3xl p-6 px-8 group overflow-hidden relative'>
                        {banners.top_right ? (
                            <img src={banners.top_right} alt="Top Right Banner" className="absolute inset-0 w-full h-full object-cover" />
                        ) : (
                            <>
                                <div>
                    ...
                    <div className='flex-1 flex items-center justify-between w-full bg-blue-200 rounded-3xl p-6 px-8 group overflow-hidden relative'>
                        {banners.bottom_right ? (
                            <img src={banners.bottom_right} alt="Bottom Right Banner" className="absolute inset-0 w-full h-full object-cover" />
                        ) : (
                            <>
                                <div>
