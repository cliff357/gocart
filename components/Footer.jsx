        ...
        <footer className="text-white" style={{ backgroundColor: '#9E4F1E' }}>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    {/* Categories Section */}
                    <div>
                        <h3 className="text-lg font-bold mb-4 tracking-wider">CATEGORIES</h3>
                    ...
                    {/* Our Policy Section */}
                    <div>
                        <h3 className="text-lg font-bold mb-4 tracking-wider">OUR POLICY</h3>
                        <ul className="space-y-2 text-sm text-white/70">
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 tracking-wider">FOLLOW US</h3>
